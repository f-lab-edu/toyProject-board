...
@RequestMapping(value="/board/v1/boards")
public class BoardController {
    ...
    public Board requestBoardByBoardId(@PathVariable int boardId){
        return boardService.findBoardByBoardId(boardId).orElseThrow(()->
                new NoSuchElementException("게시판 아이디가 "+boardId + "인 게시물을 찾을 수 없습니다."));
    }
    /**
     * 회원아이디로 게시물 조회
     * @param memberId
